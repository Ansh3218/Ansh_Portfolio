    ...
    <div className="min-h-screen bg-white/85 py-16 max-lg:py-14 max-md:py-10 max-sm:py-8">
      <div className="w-full px-14 mx-auto font-[manrope medium] max-xl:px-10 max-lg:px-8 max-md:px-6 max-sm:px-4">
        ...
        <div className="mb-16 max-lg:mb-12 max-md:mb-10">
          <p className="text-[#2C385E] text-lg mb-4 max-md:text-base">
            Contact
          </p>
          ...
          <p className="text-[#2C385E] text-xl w-[25%] leading-relaxed max-lg:w-[40%] max-md:w-[60%] max-sm:w-full max-sm:text-base">
        ...
        {/* GRID SECTION */}
        <div className="w-full grid grid-cols-2 gap-28 mb-10 max-xl:gap-20 max-lg:gap-14 max-md:gap-12 max-md:grid-cols-1">
          {/* LEFT SIDE */}
          <div className="space-y-12 max-md:space-y-10 max-sm:space-y-8">
            ...
            <div>
              ...
              <div className="relative w-full group">
                <p className="text-xl max-sm:text-lg">+00 000 00 00</p>
                <span className="absolute left-0 -bottom-1 w-full h-[1px]"></span>
                <span className="absolute left-0 -bottom-1 w-0 h-[1px] bg-black transition-all duration-300 group-hover:w-full"></span>
              </div>
            </div>
